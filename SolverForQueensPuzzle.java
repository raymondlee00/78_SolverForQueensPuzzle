    ...
    private void recordSolutionsStarted() {
        // Which has been requested, a base case or recursive case?
            if (inProgress.lastIsNg()) {
                ...
                System.out.println( "  for debugging: illegal base case detected for..."
                                  + System.lineSeparator()
                                  + inProgress
                                  );
            } else if (inProgress.accept()) {
                System.out.println( "  for debugging: legal base case detected for..."
                                  + System.lineSeparator()
                                  + inProgress
                                  );
                ...
                for (int i = 0; i < inProgress.ranks(); inProgress.populate(i), i++, recordSolutionsStarted(), inProgress.depopulate()); //populate must go before i++ to include i = 0 case {
